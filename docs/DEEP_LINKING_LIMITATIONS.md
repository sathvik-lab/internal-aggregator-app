...
- `https://foodtruckcompliance.app/...` requires domain hosting setup outside this repo:
  - iOS: Apple App Site Association (AASA) file on `foodtruckcompliance.app`.
  - Android: Digital Asset Links (`assetlinks.json`) on `foodtruckcompliance.app`.
